...
import { checkUserSubscription } from "../../actions/subcription";
      ...
      xl:px-30 max-w-7xl"
        >
          <div className="flex items-start justify-center h-full">
            {/* <Sidebar /> */}
            <div
              className="shrink-0 flex-[0.50] lg:flex-[0.28] 
          relative"
            >
              <Sidebar {...{ isPro }} />
            </div>
            <div className="flex flex-row h-screen flex-1 gap-0">
              {/* <Mainbar /> */}
              <main
                className="!bg-background lg:max-w-[40em] relative h-full
            flex-1 flex lg:flex-[0.95]"
              >
                <hr className="w-[1px] fixed h-screen bg-[#eee] dark:bg-[rgb(47,51,54)]" />
                <div className="w-[20em] lg:w-full  h-full"> {children}</div>
              </main>
